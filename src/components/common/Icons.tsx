...
export const bell: React.FC<IconProps> = ({ className }) => (
  <svg
    ...
    data-src="frontends/v3/assets/template/img/icons/theme/general/notifications-1.svg"
  >
...
const chat: React.FC<IconProps> = ({ className }) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
    className={`injected-svg icon bg-primary ${className}`}
    data-src="frontends/v3/assets/template/img/icons/theme/communication/chat-4.svg"
  >
...
const pecentage: React.FC<IconProps> = ({ className }) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
    ...
    xmlns="http://www.w3.org/2000/svg"
    className={`injected-svg icon icon-xs ${className}`}
    data-src="//redbiller.com/frontends/v3/assets/template/img/icons/theme/general/percentage.svg"
  >
