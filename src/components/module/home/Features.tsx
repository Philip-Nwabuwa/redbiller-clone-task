...
const Features = () => {
  ...
  return (
    <section className="max-w-[1280px] mx-auto lg:px-4 px-10">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:py-[120px] md:py-20 py-10">
        <div>
          ...
          <p className="max-w-[451px] mb-[1.5rem] text-[1.25rem] text-[#565a66]">
            We excite our merchants with the seamless experience of managing and
            scaling their business from one single platform.
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:pb-[120px] md:pb-20 pb-10">
        ...
        <div>
          ...
          <p className="max-w-[451px] mb-[1.5rem] text-[1.25rem] text-[#565a66]">
            Multiple payment methods increases your chances of making sales and
            scaling your business, most especially when the charges are hardly
            noticeable.
          </p>
          <div className="flex flex-col lg:flex-row lg:gap-10 mb-16">
            <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:pb-[120px] md:pb-20 pb-10">
        <div>
          ...
          <p className="max-w-[451px] mb-[1.5rem] text-[1.25rem] text-[#565a66]">
            In our approach to offering quality service, Airtime PIN generation
            is made available to our customers to allow them earn effortlessly
            by generating, printing and selling of airtime recharge cards.
          </p>
          <div className="flex flex-col lg:flex-row lg:gap-10 mb-16">
            <div>
      ...
      <div className="bg-[#f8f9fd]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:py-[120px] md:py-20 py-10">
          ...
          <div className="flex flex-col items-start justify-center">
            ...
            <p className="max-w-[451px] mb-[1.5rem] text-[1.25rem] text-[#565a66]">
              ...
              core infrastructure and enjoy a whole lot of whitelabel services.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:pb-[120px] md:pb-20 pb-10">
          <div className="flex flex-col items-start justify-center">
            ...
            <p className="max-w-[451px] mb-[1.5rem] text-[1.25rem] text-[#565a66]">
              Make faster payouts to your customers, they love it! Our APIs are
              designed to prevent duplicate transactions, which prevents you
              from crediting the same customer twice within a specific time
              frame.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:pb-[120px] md:pb-20 pb-10">
          ...
          <div className="flex flex-col items-start justify-center">
            ...
            <p className="max-w-[451px] mb-[1.5rem] text-[1.25rem] text-[#565a66]">
              Use our identity verification tools to know who your customers say
              they are before lending them money. Seamlessly disburse loans and{" "}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-2 gap-10 lg:py-[120px] md:py-20 py-10">
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <p className="max-w-[451px] mb-[1.5rem] text-[1.25rem] text-[#565a66]">
            ...
            beyond those standards to improve your trust in us. And everyday, we
